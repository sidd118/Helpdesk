...
- **Open** — ticket created, awaiting or in progress toward resolution
- **Resolved** — a response/fix has been provided
...
- The system is deployed with a single initial **admin** account.
